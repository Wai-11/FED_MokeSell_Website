document.addEventListener("DOMContentLoaded", function () {
    ...
    if (document.getElementById("register-btn")) {
        document.getElementById("register-btn").addEventListener("click", function (e) {
            ...
            function createAcc() {
                fetch(`https://mokesell-7706.restdb.io/rest/account?q={"email":"${Email}"}`, {
                    method: "GET",
                    headers: {
                    ...
                    .then((response) => {
                        ...
                        if (response.length > 0) {
                            ...
                            fetch("https://mokesell-7706.restdb.io/rest/account", settings)
            ...
            function createMembership() {
                {
                    ...
                    fetch("https://mokesell-7706.restdb.io/rest/membership", settings)
                        .then((response) => response.json())
                        .then((data) => {
                            console.log(data);
                        });
    ...
    if (loginBtn) {
        loginBtn.addEventListener("click", function (e) {
            ...
            fetch(`https://mokesell-7706.restdb.io/rest/account?q={"email":"${Email}","password":"${Password}"}`, {
                method: "GET",
                headers: {
                    "Content-Type": "application/json; charset=utf-8",
                    "x-apikey": APIKEY,
